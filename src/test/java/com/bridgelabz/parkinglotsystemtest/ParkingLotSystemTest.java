...
public class ParkingLotSystemTest {
    ...
    public void givenParkingLot_WhenVehicleIsParked_ThenReturnTrue() {
        ...
        try {
            parkingLot.isPark(NormalDriver.NORMAL_DRIVER, vehicle);
    ...
    public void givenParkingLot_CheckVehicleIsNotPresent_ShouldThrowException() {
        parkingLot.initializeParkingLot();
        try {
            parkingLot.isPark(NormalDriver.NORMAL_DRIVER, null);
    ...
    public void givenParkingLotIsFull_ShouldThrowException() {
        try {
            ...
            parkingLot.isPark(NormalDriver.NORMAL_DRIVER, secondVehicle);
            parkingLot.isPark(NormalDriver.NORMAL_DRIVER, new Object());
        } catch (ParkingLotException e) {
    ...
    public void givenParkingLot_WhenVehicleParkedOnLotPosition_ThenReturnTrue() {
        ...
        parkingLot1.initializeParkingLot();
        try {
            parkingLotSystem.isPark(NormalDriver.NORMAL_DRIVER, vehicle);
    ...
    public void givenParkingLot_ShouldParkVehicleEvenly() {
        ...
        try {
            ...
            parkingLotSystem.isPark(NormalDriver.NORMAL_DRIVER, vehicle1);
            boolean isParked2 = parkingLotSystem.isVehiclePark(vehicle1);
            parkingLotSystem.isPark(NormalDriver.NORMAL_DRIVER, vehicle2);
            boolean isParked3 = parkingLotSystem.isVehiclePark(vehicle2);
            parkingLotSystem.isPark(NormalDriver.NORMAL_DRIVER, vehicle3);
    ...
    public void givenDriverTypeIsHandicap_ShouldParkVehicleAtNearestPlace() {
        ...
        try {
            ...
            parkingLotSystem.isPark(NormalDriver.NORMAL_DRIVER, vehicle2);
            parkingLotSystem.isPark(NormalDriver.NORMAL_DRIVER, vehicle3);
            parkingLotSystem.isPark(HandicapDriver.HANDICAP_DRIVER, vehicle4);
            parkingLotSystem.isPark(NormalDriver.NORMAL_DRIVER, vehicle5);
